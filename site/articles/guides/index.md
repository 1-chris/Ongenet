...
Step-by-step guides for using Ongenet — from your first session to advanced workflows.

| Guide | Summary |
| --- | --- |
| [Getting started](getting-started.md) | First launch, projects, library, settings |
| [Samples & libraries](samples-and-libraries.md) | Add sample folders, soundfonts, drag-and-drop |
| [Factory content](factory-content.md) | Catalogue, licences, attribution for Content/Core |
| [Plugins](plugins.md) | Install and use CLAP, LV2, VST, AU plugins |
| [Timeline & clips](timeline-and-clips.md) | Arrange view, recording, comping, clip tools |
