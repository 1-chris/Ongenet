(function () {
  ...
  function bsThemeFor(id) {
    return id === 'latte' ? 'light' : 'dark';
  }

  function setTheme(id, persist) {
    if (!THEMES[id]) return;
    document.documentElement.setAttribute('data-theme', id);
    document.documentElement.setAttribute('data-bs-theme', bsThemeFor(id));
    ...
    if (persist !== false) {
      ...
      localStorage.setItem('theme', bsThemeFor(id));
    }
  }
  ...
  // DocFX loads its own Bootstrap theme after defer scripts — re-apply ours once.
