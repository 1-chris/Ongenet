...
| Piece | Role |
| --- | --- |
| [`PitchNoteSegment`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Models/Audio/PitchNoteSegment.cs) | Start/end sample, pitch cents, amplitude |
| [`Clip.PitchSegments`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Models/Audio/Clip.cs) | Per-clip segment list (project format v7) |
| [`PolyphonicPitchAnalyzer`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Files/PolyphonicPitchAnalyzer.cs) | Seeds segments from polyphonic detection |
| [`AudioClipPitch`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/AudioClipPitch.cs) | Real-time per-segment ratios + edge crossfades |
| [`PolyphonicPitchEditorWindow`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Views/Windows/PolyphonicPitchEditorWindow.axaml) | Analyze / edit UI with waveform overlays |
