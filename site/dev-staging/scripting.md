...
Desktop only. Web and Android register [`NullScriptingHost`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Services/IScriptingHost.cs).

## Opening the Scripts panel

**Tools → Scripts** opens the Scripts window. Factory scripts auto-load from the `Scripts/` folder
next to the desktop executable (copied from [`Ongenet.App/Scripts/`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Scripts/) on build).
...
A global `api` object implementing [`IScriptingApi`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Services/IScriptingApi.cs) is available:
...
Implementation: [`RoslynScriptingHost`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Scripting/RoslynScriptingHost.cs).
...
| File | What it does |
| --- | --- |
| [`SetTempo120.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Scripts/SetTempo120.cs) | Sets tempo to 120 BPM |
| [`RenameTracksPrefix.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Scripts/RenameTracksPrefix.cs) | Prefixes all track names |
| [`QuantizeAllMidi.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Scripts/QuantizeAllMidi.cs) | Quantizes MIDI clips to 1/16 |
...
1. Add methods to [`IScriptingApi`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Services/IScriptingApi.cs).
...
4. Cover load/invoke in [`ScriptingHostTests`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core.Tests/Services/ScriptingHostTests.cs).
