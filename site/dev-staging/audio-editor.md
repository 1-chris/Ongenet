...
| Piece | Role |
| --- | --- |
| [`SampleEditorCoreViewModel`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/ViewModels/SampleEditorCoreViewModel.cs) | Shared waveform state, cut/copy/paste, spectral overlay, audition |
| [`SampleInspectorViewModel`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/ViewModels/SampleInspectorViewModel.cs) | Thin wrapper — tempo, warp, key detect/change |
| [`AudioEditorViewModel`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/ViewModels/AudioEditorViewModel.cs) | Multitrack lanes; one core editor per open clip |
| [`SampleEditorView`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Views/Panels/SampleEditorView.axaml) | Reusable AXAML host for the waveform toolbar |
| [`IAudioEditorService`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Services/IAudioEditorService.cs) | Opens/activates the standalone window from menus and the timeline |
