...
- [`WaveformVisualizerEffect.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Effects/WaveformVisualizerEffect.cs)
- [`WaveformTrailVisualization.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Controls/Engine3D/WaveformTrailVisualization.cs)
- [`WaveformVisualizerEffectViewModel.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/ViewModels/Effects/WaveformVisualizerEffectViewModel.cs)
- [`EffectChainView.axaml`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Views/Panels/EffectChainView.axaml) (the `3D Scope` `DataTemplate`)
...
The audio→UI hand-off is a **lock-free ring buffer**, [`SpectrumScope`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Dsp/SpectrumScope.cs):
...
[`EffectRegistry.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Effects/EffectRegistry.cs):
...
[`WaveformTrailVisualization`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Controls/Engine3D/WaveformTrailVisualization.cs) adds the
...
[`Engine3DVisualHost`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Controls/Engine3DVisualHost.cs) does everything: it owns the GPU view,
...
[`Engine3DVisualWindow`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Views/Windows/Engine3DVisualWindow.axaml). All it needs is a
...
[`EffectChainViewModel.Rebuild()`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/ViewModels/Effects/EffectChainViewModel.cs) (Avalonia
...
[`EffectChainView.axaml`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Views/Panels/EffectChainView.axaml) — the shared `EffectHeaderView`
