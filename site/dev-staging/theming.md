...
All theming code lives in the shared UI library [`Ongenet.App`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App), under
[`Theming/`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming) plus
[`Controls/ThemedControl.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Controls/ThemedControl.cs) and
[`App.axaml`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/App.axaml). Both the desktop and web heads get theming for free because
...
list in [`ThemePalette.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/ThemePalette.cs):
...
Both are declared in [`App.axaml`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/App.axaml) (the startup values are Catppuccin Mocha):
...
([`ThemeDefinition.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/ThemeDefinition.cs)). The
[`ThemeService`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/ThemeService.cs) does the work.
...
[`ThemedControl`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Controls/ThemedControl.cs) bridges that gap. Inherit from it, and it
...
from [`CurveEditorControl`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Controls/CurveEditorControl.cs):
...
([`CoreColorToBrushConverter`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Converters/CoreColorToBrushConverter.cs)), which resolves
...
([`ThemeEditorView`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Views/Settings/ThemeEditorView.axaml)) wires up the file pickers and
...
([`AppSettingsService`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Services/AppSettingsService.cs)). Custom per-token edits and
...
[`BuiltInThemes.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/BuiltInThemes.cs) — the **only** place colour codes are
...
In [`BuiltInThemes.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/BuiltInThemes.cs):
...
[`App.axaml.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/App.axaml.cs) loads the XAML resources, registers `IThemeService` in DI,
...
| File | Role |
| --- | --- |
| [`Theming/ThemePalette.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/ThemePalette.cs) | The 26 tokens, shared-brush registry, `Changed` event, colour accessors |
| [`Theming/ThemeService.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/ThemeService.cs) | Apply/SetToken (live mutation), JSON import/export, invalidation |
| [`Theming/ThemeDefinition.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/ThemeDefinition.cs) | A theme = name + variant + token map |
| [`Theming/BuiltInThemes.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Theming/BuiltInThemes.cs) | The four Catppuccin flavours |
| [`Controls/ThemedControl.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Controls/ThemedControl.cs) | Base class for theme-aware custom-drawn controls |
| [`App.axaml`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/App.axaml) | The `Color` + `SolidColorBrush` resource definitions and global styles |
| [`Views/Settings/ThemeEditorView.axaml`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Views/Settings/ThemeEditorView.axaml) | The Settings → Theme UI |
| [`Converters/CoreColorToBrushConverter.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.App/Converters/CoreColorToBrushConverter.cs) | Resolves entity colour keys → live brushes |
