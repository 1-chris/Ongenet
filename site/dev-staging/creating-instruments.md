...
Everything here lives in [`Ongenet.Core`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core) (`Audio/Instruments`, `Audio/Dsp`,
...
> ([`OscillatorInstrument.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/OscillatorInstrument.cs)), rename it,
...
[`SamplerInstrument`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/Sampler/SamplerInstrument.cs) does, because it
...
[`Ongenet.Core/Audio/Dsp`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Dsp). These are the shared, audio-thread-safe
...
Three concrete kinds live in [`Audio/Parameters`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Parameters):
...
[`OscillatorInstrument.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/OscillatorInstrument.cs). It is a
...
- [`Oscillator.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/Oscillator.cs) keeps a `_phase` in `[0,1)` and
  advances it by `frequency / sampleRate` each sample, mapping that phase to a sine/saw/square shape.
- [`AdsrEnvelope.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/AdsrEnvelope.cs) is a little state machine
...
[`FmSynthInstrument`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/FmSynthInstrument.cs) (two-operator FM),
[`TripleOscInstrument`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/TripleOscInstrument.cs) (three oscillators +
filter), [`PaddaInstrument`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/PaddaInstrument.cs) (unison + an
internal effect chain, overriding `Render`), and
[`KickaInstrument`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/KickaInstrument.cs) (a one-shot drum synth).
...
[`BasicSamplerInstrument`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/BasicSamplerInstrument.cs). It is still a
...
[`Sampler/SamplerInstrument.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/Sampler/SamplerInstrument.cs). It
...
[`InstrumentRegistry`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Audio/Instruments/InstrumentRegistry.cs). Each entry is an
