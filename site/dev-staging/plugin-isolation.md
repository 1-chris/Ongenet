...
| Piece | Path |
| --- | --- |
| IPC protocol | [`PluginHostIpc.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Services/PluginHostIpc.cs) |
| Child process | [`Ongenet.PluginHost/`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.PluginHost/) |
| Host launcher | [`OutOfProcessPluginHost.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Desktop/Services/OutOfProcessPluginHost.cs) |
| Effect proxy | [`RemotePluginProxy.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Desktop/Services/RemotePluginProxy.cs) |
| Seam | [`IPluginProcessHost.cs`](https://github.com/1-chris/Ongenet/blob/main/Ongenet.Core/Services/IPluginProcessHost.cs) |
