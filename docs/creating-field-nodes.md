...
Both host an editable [`FieldGraph`](../Ongenet.Core/Audio/Field/FieldGraph.cs) and run an immutable
[`CompiledGraph`](../Ongenet.Core/Audio/Field/CompiledGraph.cs) snapshot produced by the
[`FieldGraphCompiler`](../Ongenet.Core/Audio/Field/FieldGraphCompiler.cs). Editing the graph recompiles off
...
allocated/stolen by [`FieldVoiceManager`](../Ongenet.Core/Audio/Field/FieldVoiceManager.cs) and freed a few
...
[`FieldNodeCatalog`](../Ongenet.Core/Audio/Field/FieldNodeCatalog.cs), grouped by category
...
[`Ongenet.Core/Audio/Dsp`](../Ongenet.Core/Audio/Dsp).
...
[`FieldModuleNodes`](../Ongenet.Core/Audio/Field/FieldModuleNodes.cs). So you can drop a whole Reverb, a
whole Padda, or a plugin into a graph and modulate its parameters.

**Built-in patches.** [`FieldBuiltInPatches`](../Ongenet.Core/Audio/Field/Patches/FieldBuiltInPatches.cs)
...
Subclass [`FieldNode`](../Ongenet.Core/Audio/Field/FieldNode.cs). Declare ports and parameters in the
...
[`FieldGraphSerializer`](../Ongenet.Core/Persistence/FieldGraphSerializer.cs) as the Field component's
