...
| `Ongenet.Scripting`             | Roslyn                  | C# scripting host for batch automation — exposes a curated `IScriptingApi` (transport, project, tracks, MIDI quantize) via Roslyn. Factory scripts ship under `Ongenet.App/Scripts/`. Desktop-only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| **Scripts**          | Tools → Scripts — run C# automation scripts against the project via Roslyn (`IScriptingApi`). Factory scripts for tempo, track rename, and MIDI quantize. |
...
| Scripting / automation                      | **Good** — Roslyn C# scripts with curated `IScriptingApi`; Tools → Scripts panel |
