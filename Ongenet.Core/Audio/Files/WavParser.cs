...
/// <summary>
/// Dependency-free RIFF/WAVE parsing, decoding to an interleaved float <see cref="AudioSampleBuffer"/>.
/// Handles PCM 8/16/24/32-bit and IEEE float 32/64-bit (including WAVE_FORMAT_EXTENSIBLE). Shared by
/// the WAV decoder and the ffmpeg decoder (which transcodes other formats to a temporary WAV).
/// </summary>
public static class WavParser
{
    ...
    /// <summary>Parses a RIFF/WAVE stream into interleaved float PCM.</summary>
