...
public sealed class SfzSample
{
    ...
    private SfzSample(int channels, int sampleRate, long frameCount, AudioSampleBuffer? resident,
    ...
    public static SfzSample FromResident(AudioSampleBuffer buffer)
    ...
    public static SfzSample FromStream(string path, long dataOffset, int channels, int sampleRate, int bits,
