...
/// <summary>
/// Per-voice disk streaming state for one streamed <see cref="SamplerSample"/>: a single-producer
...
/// </summary>
public sealed class SamplerStream
{
    ...
    public void Request(SamplerSample sample, long startFrame)
    {
        _sample = sample;
